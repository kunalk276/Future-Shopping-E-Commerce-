                ...
                <div class="category">
                    ...
                    <ul>
                        @foreach ($category as $item)
                            <li style="color:{{ $item->id == $cate ? '#3da8f3' : '' }}" onclick="updateQuery('category', {{ $item->id }})">
                                {{ ucfirst($item->title) }}
                            </li>   
                        @endforeach
                    </ul>
            ...
            <div class="products-section">
                ...
                @else
                    <div style="display: grid; place-items: center">
                        <img style="max-width: 100%" src="{{ asset('img/no-product-found.png') }}" alt="No product found">
                    </div>
                @endif
            </div>
        </main>
